...
export default function EasiestWay() {
	...
	return (
		<div className='relative px-0 mx-auto container max-w-7xl my-14 lg:mt-[120px]'>
			{/* Container Content */}
			<div className='relative flex justify-center items-center w-full h-[50ch] md:h-[400px]'>
				{/* Image background */}
				{/* Dekstop */}
				...
				<div className='relative z-0 flex flex-col justify-center items-center'>
					...
					<Fade top delay={200}>
						<Link href='/community' passHref>
							<a className='header__download-button text-slate-900 bg-white py-3 px-11 inline-block text-base font-bold cursor-pointer'>
								{t('home:Learn More')}
							</a>
						</Link>
					</Fade>
