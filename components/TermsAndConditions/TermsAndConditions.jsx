	...
	return (
        ...
        > 
            ...
            <div>
                ...
                <p>Users acknowledge and accept that by providing their own content on this Application they grant the Owner a non-exclusive, fully paid-up and royalty-free licence to process such content solely for the operation and maintenance of this Application as contractually required.</p>
                ...
                <div className="mb-2">
                <h2>Removal of content from parts of this Application available through the App Store</h2>
                ...
                <div className="mb-2">
                <h2>“Tell-a-friend”</h2>
                <p>This Application gives Users the opportunity to receive advantages if, as a result of their recommendation, any new User purchases a Product offered on this Application.</p>
                <p>In order to take advantage of this offer, Users may invite others to purchase the Products on this Application by sending them a tell-a-friend code provided by the Owner. Such codes can only be redeemed once.</p>
                <p>If upon purchase of the Products on this Application any of the persons invited redeems a tell-a-friend code, the inviting User shall receive the advantage or benefit (such as: a price reduction, an additional service feature, an upgrade etc.) specified on this Application.</p>
                <p>Tell-a-friend codes may be limited to specific Products among those offered on this Application.</p>
                ...
                <p>This licence does not grant Users any rights to access, usage or disclosure of the original source code. All techniques, algorithms, and procedures contained in the software and any documentation thereto related is the Owner’s or its licensors’ sole property.</p>
                <p>All rights and licence grants to Users shall immediately terminate upon any termination or expiration of the Agreement.</p>
                <p>Without prejudice to the above, under this licence Users may download, install, use and run the software on the permitted number of devices, provided that such devices are common and up-to-date in terms of technology and market standards.</p>
                ...
                <div className="mb-2">
                <h1 className='text-2xl'>TERMS AND CONDITIONS OF SALE</h1>
                </div>
                <div className="mb-2">
                <h2>Paid Products</h2>
                ...
                <div className="mb-2">
                <h2>Virtual Currency for exclusive use inside this Application</h2>
                <p>On this Application certain payments may be made using a Virtual Currency. Unless otherwise stated, such Virtual Currency is not tradable, exchangeable or redeemable against any traditional currency, any other open digital currency, goods or any other values.</p>
                <p>By purchasing Virtual Currency, Users acknowledge and understand that it may only be used within this Application for the purposes expressly authorised by the Owner within the framework of its Services. Users also acknowledge and agree that they may not transfer, purchase, sell, or exchange such Virtual Currency outside of the Service.</p>
                <p>Accordingly, Users may not sublicense, trade, sell or attempt to sell Virtual Currency for money, or exchange Virtual Currency for value of any kind outside of the dedicated offering provided by the Owner through this Application. Any such prohibited use or transaction shall be considered null and void and could result in legal action being taken against the User.</p>
                <p>In case of contract or account termination for any cause attributable to the User, any and all unused Virtual Currency shall be forfeited and no refund shall be granted.</p>
                </div>
                <div className="mb-2">
                <h2>Retention of usage rights</h2>
                ...
                <div className="mb-2">
                <h1 className='text-2xl'>User rights</h1>
                </div>
                <div className="mb-2">
                ...
                <p>The right of withdrawal does not apply to contracts that have been entered into with the Owner. It may, however, apply to contracts entered into with Sellers. If applicable, the right to withdraw from contracts entered into with Sellers via this Application is subject to the conditions and specifications made available by each Seller on this Application.</p>
                </div>
                <div className="mb-2">
                <h1 className='text-2xl'>Liability and indemnification</h1>
                </div>
                <div className="mb-2">
                <h1 className='text-xl'>EU Users</h1>
                </div>
                <div className="mb-2">
                ...
                <div className="mb-2">
                <h1 className='text-2xl'>Australian Users</h1>
                </div>
                <div className="mb-2">
                <h2>Limitation of liability</h2>
                ...
                <div className="mb-2">
                <h1 className='text-xl'>US Users</h1>
                </div>
                <div className="mb-2">
                ...
                <ul className="list-disc">
                    ...
                    <li>personal injury or property damage, of any nature whatsoever, resulting from User access to or use of the Service;</li>
                    <li>any unauthorised access to or use of the Owner’s secure servers and/or any and all personal information stored therein;</li>
                ...
                <ul className="list-disc">
                    ...
                    <li>statutory provision by User or its affiliates, officers, directors, agents, co-branders, partners, suppliers and employees to the extent allowed by applicable law.</li>
                </ul>
                </div>
                <div className="mb-2">
                <h1 className='text-2xl'>Common provisions</h1>
                </div>
                <div className="mb-2">
                <h2>No Waiver</h2>
                ...
                <p>Additionally, the Service might not be available due to reasons outside the Owner’s reasonable control, such as “force majeure” (eg. labour actions, infrastructural breakdowns or blackouts etc).</p>
                </div>
                <div className="mb-2">
                ...
                <div className="mb-2">
                <h2>Exception for European Consumers</h2>
                ...
                <div className="mb-2">
                <h2>This Application (or this Application)</h2>
                ...
                <p>A non-monetary asset by which Users may purchase specific Products offered on this Application under the conditions specified by the Owner. Such assets can be manifested by codes, tokens, digital images etc.</p>
                </div>
                <div className="mb-2">
                <h2>Consumer</h2>
