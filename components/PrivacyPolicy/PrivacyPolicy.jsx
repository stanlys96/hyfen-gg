...
export default function PrivacyPolicy() {
	return (
		<div className='privacy-policy-bg py-24'>
            <div
                className='privacy-policy-content container mx-auto'
            >
                ...
                <div>
                    ...
                    <p>Player One Guild Ltd - 2077508</p>
                ...
                <div>
                    ...
                    <p>Among the types of Personal Data that this Application collects, by itself or through third parties, there are: Trackers; Usage Data; first name; last name; phone number; country; email address; gender; date of birth; Data communicated while using the service.</p>
                </div>
                <div>
        ...
        Personal Data may be freely provided by the User, or, in case of Usage Data, collected automatically when using this Application.</p>
                ...
                <div>
                    ...
                    <p>The Owner takes appropriate security measures to prevent unauthorised access, disclosure, modification, or unauthorised destruction of the Data.</p>
                ...
                <div>
                    ...
                    <p>Google Analytics is a web analysis service provided by Google LLC (“Google”). Google utilises the Data collected to track and examine the use of this Application, to prepare reports on its activities and share them with other Google services.
                    ...
                    <p>This processing constitutes a sale based on the definition under the CCPA. In addition to the information in this clause, the User can find information regarding how to opt out of the sale in the section detailing the rights of California consumers.</p>
                </div>
                <div>
                    <h3>Contacting The User<br /> Contact form (this Application)</h3>
                    ...
                    <p>Personal Data processed: country; email address; first name; last name; phone number. Category of personal information collected according to CCPA: identifiers.</p>
                </div>
                <div>
                ...
                <div>
                    <h3>Google Fonts (Google LLC)</h3>
                    <p>Google Fonts is a typeface visualisation service provided by Google LLC that allows this Application to incorporate content of this kind on its pages.</p>
                    <p>Personal Data processed: Trackers; Usage Data.</p>
                    <p>
                    ...
                    <p>
                    This processing constitutes a sale based on the definition under the CCPA. In addition to the information in this clause, the User can find information regarding how to opt out of the sale in the section detailing the rights of California consumers.
                    </p>
                </div>
                <div>
                ...
                <div>
                    <h3>Amazon Web Services (AWS) (Amazon Web Services, Inc.)</h3>
                ...
                <div>
                    <h3>Managing Contact & Sending Massage</h3>
                ...
                <div>
                    <h3>Sendgrid (Sendgrid)</h3>
                    <p>Sendgrid is an email address management and message sending service provided by Sendgrid Inc.</p>
                    <p>Personal Data processed: country; date of birth; email address; first name; gender; last name; phone number.</p>
                    <p>Place of processing: United States </p>
                    <p>Category of personal information collected according to CCPA: identifiers; biometric information.</p>
                    <p>This processing constitutes a sale based on the definition under the CCPA. In addition to the information in this clause, the User can find information regarding how to opt out of the sale in the section detailing the rights of California consumers.</p>
                </div>
                <div>
                    <h3>Managing Support & Contact Request</h3>
                ...
                <div>
                    <h2>Cookie Policy</h2>
                    <p>This Application uses Trackers. To learn more, the User may consult the Cookie Policy.</p>
                </div>
                <div>
                ...
                <div>
                    ...
                    <p>We have collected the following categories of personal information about you: identifiers, biometric information and internet information.</p>
                    <p>We will not collect additional categories of personal information without notifying you.</p>
                </div>
                <div>
                    <h3>How we collect information: what are the sources of the personal information we collect?</h3>
                ...
                <div>
                    <h3>How we use the information we collect: sharing and disclosing of your personal information with third parties for a business purpose</h3>
                    <p>We may disclose the personal information we collect about you to a third party for business purposes. In this case, we enter a written agreement with such a third party that requires the recipient to both keep the personal information confidential and not use it for any purpose(s) other than those necessary for the performance of the agreement.</p>
                    <p>We may also disclose your personal information to third parties when you explicitly ask or authorise us to do so, in order to provide you with our Service.</p>
                ...
                <div>
                    <h3>Your right to opt out of the sale of personal information</h3>
                    <p>You have the right to opt out of the sale of your personal information. This means that whenever you request us to stop selling your data, we will abide by your request.</p>
                    <p>Such requests can be made freely, at any time, without submitting any verifiable request, simply by following the instructions below.</p>
                </div>
                <div>
                    <h3>Instructions to opt out of the sale of personal information</h3>
                ...
                <div>
                    <h3>What are the purposes for which we use your personal information?</h3>
                ...
                <div>
                    ...
                    <p>If you cannot personally submit a verifiable request, you can authorise a person registered with the California Secretary of State to act on your behalf.</p>
                ...
                <div>
                    ...
                    <p>We will respond to your request within 45 days of its receipt. Should we need more time, we will explain to you the reasons why, and how much more time we need. In this regard, please note that we may take up to 90 days to fulfil your request.</p>
                    <p>Our disclosure(s) will cover the preceding 12 month period.</p>
                    <p>Should we deny your request, we will explain to you the reasons behind our denial.</p>
                ...
                <div>
                    <h3>How to file your request</h3>
                ...
                <div>
                    <h3>How and when we will respond to your request</h3>
                    <p>We will strive to promptly respond to your requests.</p>
                    <p>In any case, should it be impossible for us to do so, we’ll make sure to communicate to you the factual or legal reasons that prevent us from immediately, or otherwise ever, complying with your requests. In cases where we are not processing your personal information, we will indicate to you the physical or legal person to whom you should address your requests, if we are in the position to do so.</p>
                    <p>In the event that you file an access or personal information processing confirmation request, please make sure that you specify whether you’d like your personal information to be delivered in electronic or printed form.</p>
                    <p>You will also need to let us know whether you want us to answer your request immediately, in which case we will answer in a simplified fashion, or if you need a complete disclosure instead.</p>
                ...
                <div>
                    ...
                    <p>when the transfer results from a commitment undertaken in an international cooperation agreement;</p>
                    <p>when the transfer is necessary for the execution of a public policy or legal attribution of public service;</p>
                    <p>when the transfer is necessary for compliance with a legal or regulatory obligation, the carrying out of a contract or preliminary procedures related to a contract, or the regular exercise of rights in judicial, administrative or arbitration procedures.</p>
                    </ul>
                </div>
                <div>
                ...
                <div>
                    ...
                    <p>This privacy statement has been prepared based on provisions of multiple legislations, including Art. </p>
                    <p>13/14 of Regulation (EU) 2016/679 (General Data Protection Regulation).</p>
