							...
							<div className='relative pb-8 flex flex-col items-center grow justify-center w-full'>
								...
								<div className='w-full h-full z-10 text-center'>
									<Image
										...
										quality={100}
									/>
									<h5 className='text-lg md:text-xl font-bold'>{t('for_players')}</h5>
									...
									passHref
										href='/players'
									>
										<div className='header__download-button hover:text-black-100 transition hover:bg-white py-3 px-11 inline-block text-xs md:text-sm font-bold cursor-pointer'>{t('GET STARTED')}</div>
									</Link>
								</div>
							</div>
						</Fade>
							...
							<div className='relative pb-8 flex flex-col items-center grow justify-center'>
								...
								<div className='w-full h-full z-10 text-center'>
									<Image
										...
										height='230'
									/>
									<h5 className='text-lg md:text-xl font-bold'>{t('for_guilds')}</h5>
									<p className='text-xs md:text-sm py-4 max-w-xs mx-auto opacity-80'>
										{t('cross_des2')}.
									</p>
									<Link
