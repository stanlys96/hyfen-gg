    ...
    <div className="flex justify-center group">
      <div className="group">
        ...
        `}
          ...
          >
            <DropdownItem additionalClassName="grid grid-cols-3" href="https://apps.apple.com/us/app/metabase-play/id1624878820">
              <div className="hover:bg-gray-100" style={{ marginRight: '15px' }}>
                <AppleIcon />
              </div>
              <p className="col-span-2">{t('common:For IOS')}</p>
            </DropdownItem>
            <DropdownItem additionalClassName="grid grid-cols-3" href='https://play.google.com/store/apps/details?id=com.metabase.gg'>
              <div className="hover:bg-gray-100" style={{ marginRight: '15px' }}>
                <AndroidLogo />
              </div>
...
function AppleIcon() {
  return (
    <svg width="25" height="26" viewBox="0 0 20 25" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
