            ...
            <div className="container mx-auto">
                <form ref={form}>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 w-full gap-x-12">
                        <Fade left>
                            <InputDropdown question={question} setQuestion={setQuestion} title={t('Your Inquiry')} />
                        </Fade>
                    </div>
...
function InputTextWithIcon({
    ...
    return <div>
                ...
                <div className="relative flex items-center">
                    ...
                    }} value={thisType === "email" ? userEmail : userName} placeholder={placeholder} name={thisType === "email" ? "user_email" : "user_name"} type={thisType === "email" ? "email" : "text"} className="
                        block
                        w-full
                        rounded-md
...
function InputDropdown({title, question, setQuestion}) {
    ...
    return <div className="my-6 md:my-7">
            ...
            <div className="relative flex items-center">
                ...
                }} placeholder="" type="text" name="question" className="
                    block
                    w-full
                    rounded-md
                    border-contact-select
