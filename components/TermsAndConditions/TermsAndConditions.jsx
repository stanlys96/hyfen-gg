	...
	return (
        ...
        > 
            ...
            <div>
                ...
                <p className="text-xl font-bold py-3">{t('DigitalAssetTransactions')}</p>
                <p>{t('DigitalAssetTransactions_desc1')}</p>
                <p className="text-xl font-bold py-3">{t('AccuracyOfInformationProvided')}</p>
                <p>{t('AccuracyOfInformationProvided_desc1')}</p>
                <p className="text-xl font-bold py-3">{t('DigitalWalletRegistration')}</p>
                ...
                <p>{t('Tax_desc1')}</p>
                <p className="text-xl font-bold py-3">{t('ServicesAndThirdPartyContent')}</p>
